<?php 
	...
	function listReviews($db)
	{
		...
		{
			echo 'You can only edit reviews that you own, however you can view all reviews.<br>';
			renderReviews($db);
		} 
		else 
		{
			echo 'Please log In if you wish to edit/create reviews. <br> You can view reviews without logging in however you cannot edit them if you did not create them. <br>';
			renderReviews($db);
		}
	}
